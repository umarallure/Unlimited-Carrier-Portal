...
const CANONICAL_CALL_CENTER_ALIASES: Array<{ canonical: string; aliases: string[] }> = [
  ...
  { canonical: 'Leaders bpo', aliases: ['Leaders bpo', 'Leaders BPO', 'Leaders'] },
  ...
  { canonical: 'Sellerz', aliases: ['Sellerz', 'SellerZ', 'Seller Z', 'Sellerz BPO', 'SellerZ BPO', 'Seller Z BPO'] },
  { canonical: 'Tauras Technology', aliases: ['Tauras Technology', 'Tauras', 'Taurus Technology', 'Taurus'] },
  { canonical: 'Winnerz limited', aliases: ['Winnerz limited', 'Winnerz Limited', 'Winnerz', 'Winners', 'Winners Limited'] },
